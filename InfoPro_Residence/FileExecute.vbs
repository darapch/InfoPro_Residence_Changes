...
str_username = arr_Arg(3)
str_password = arr_Arg(4)
str_urlHost = arr_Arg(5)
strTestId = arr_Arg(6)
str_testResult = ""
...
obj_QTP.Test.Environment("QuoteNumber") = "B"&str_quoteNumber
obj_QTP.Test.Environment("LOB") = str_lob
obj_QTP.Test.Environment("UsName") = str_username
obj_QTP.Test.Environment("PWORD") = str_password
...
str_fileName = str_driverPath&"\Result\"&"B"&str_quoteNumber &".txt"
...
If (str_status = "PASSED") Then
	str_testResult = "{""AccountNumber"":"""&int_accountNumber &""",""Result"":true,""Output"":""Infopro test passed successfully and account number generated"""}"
Else
...
str_url = str_urlHost & "/api/endtoend/infoproresult?testid=" & strTestId
