...
If (TEWindow("InfoProWindow").TEScreen("BIGAA002").TEField("ContainerInfo").Exist(5)) Then
	...
	Call BIGAA002_CONT_RATE_INFO()
	Wait(1)
End If 'If (TEWindow("InfoProWindow").TEScreen("BIGAA002").TEField("ContainerInfo").Exist(5)) Then
